 ...
 */
declare function defineFlatConfig<T extends Linter.FlatConfig = Linter.FlatConfig>(config: T): T;
 ...
 */
declare function mergeConfigs<T extends Linter.FlatConfig = Linter.FlatConfig>(...configs: T[]): T;
 ...
 * ```
 */
declare function concat<T extends Linter.FlatConfig = Linter.FlatConfig>(...configs: Awaitable<T | T[]>[]): Promise<T[]>;
 ...
 * ```
 */
declare function renamePluginsInConfigs<T extends Linter.FlatConfig = Linter.FlatConfig>(configs: T[], map: Record<string, string>): T[];

/**
 * Awaitable array of ESLint flat configs or a composer object.
 */
type ResolvableFlatConfig<T extends Linter.FlatConfig = Linter.FlatConfig> = Awaitable<Arrayable<T>> | Awaitable<Linter.FlatConfig[]> | FlatConfigComposer<any>;
/**
 ...
 * ```
 */
declare function composer<T extends Linter.FlatConfig = Linter.FlatConfig, ConfigNames extends string = keyof DefaultConfigNamesMap>(...configs: ResolvableFlatConfig<Linter.FlatConfig extends T ? T : Linter.FlatConfig>[]): FlatConfigComposer<Linter.FlatConfig extends T ? T : Linter.FlatConfig, ConfigNames>;
/**
 * The underlying impolementation of `composer()`.
 */
declare class FlatConfigComposer<T extends object = Linter.FlatConfig, ConfigNames extends string = keyof DefaultConfigNamesMap> extends Promise<T[]> {
    private _operations;
 ...
 */
declare class FlatConfigPipeline<T extends object = Linter.FlatConfig, ConfigNames extends string = string> extends FlatConfigComposer<T, ConfigNames> {
}
 ...
 * ```
 */
declare function extend(configs: Awaitable<Linter.FlatConfig[]>, relativePath: string): Promise<Linter.FlatConfig[]>;
